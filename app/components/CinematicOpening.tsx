      ...
      {shouldShow && (
        ...
        >
          ...
          <div className="relative z-10 flex flex-col items-center px-6 text-center">
            ...
            <motion.h1
              className="mt-4 bg-[linear-gradient(180deg,#F5EBE1_0%,#BBA486_100%)] bg-clip-text font-serif text-[clamp(40px,9.5vw,104px)] font-medium leading-[1.0] tracking-[-0.01em] text-transparent"
