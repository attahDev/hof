...
/**
 * Ambient narration track. Drop an mp3 at this path to activate it —
 * everything here degrades gracefully (dock stays visible but disabled)
 * if the file doesn't exist yet.
 */
const NARRATION_SRC = "/audio/hall-of-fame-narration.mp3";
